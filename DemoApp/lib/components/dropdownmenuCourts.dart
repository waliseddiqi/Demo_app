...
class DropDownMenuCourt extends StatefulWidget {
  ...
  const DropDownMenuCourt(
      {Key key, this.firstmobile, this.secondmobile, this.address})
      : super(key: key);
...
class _DropDownMenuCourtState extends State<DropDownMenuCourt>
  ...
  void initState() {
    ...
    offset = Tween<Offset>(begin: Offset(0, 0), end: Offset(0, 0.05))
          ...
          child: Container(
            ...
            child: Column(
              children: [
                ...
                widget.firstmobile == null
                    ? SizedBox()
                    : textWidget(widget.firstmobile ?? "", size, "Mobile"),
                widget.secondmobile == null
                    ? SizedBox()
